...
OBJS := \
	...
	$(obj).target/$(TARGET)/lib/node_add_on/mac/meeting_recording_service.o \
	...
	$(obj).target/$(TARGET)/lib/node_add_on/zoom_node_meeting_recording_ctrl.o \
...
$(builddir)/zoomsdk.node: export SDKROOT := /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk
...
$(builddir)/zoomsdk.node: export XCODE_VERSION_ACTUAL := 1251
